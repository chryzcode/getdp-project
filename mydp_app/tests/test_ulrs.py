...
class TestUrls(SimpleTestCase):
    ...
    def test_create_banner_urls_resolves(self):
        url = reverse('create-banner')
        self.assertEquals(resolve(url).func, createBanner)

    def test_user_profile_urls_resolves(self):
