...
class TestViews(TestCase):
    ...
    #     )
    #     response = self.client.post(
    #         reverse("edit-banner", args=["the-test-banner"]),
    #         {
    #             "name": "The Test Banner",
    ...
    def test_create_user_banner(self):
        response = self.client.post(
            reverse("use-banner", args=["testbanner"]),
            {
                "user": self.user,
                "banner": self.banner,
                "image": "testimage.jpg",
    ...
    def test_logout(self):
        response = self.client.post(
            self.logout_url,
            {"email": "alabaolanrewaju13@gmail.com", "password": "flyingaway13"},
        )
        self.assertEquals(response.status_code, 302)
    ...
    def test_login(self):
        ...
        response = self.client.post(
            self.register_url, register_user, format="text/html"
        )
